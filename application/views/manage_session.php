...
<!-- dont disturb here -->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                    Please be noted that, after clicking this button, your will be redirect into the chat page. This session automatically close and need to restart session to continue.
                       <form action="" method="POST">
                           <input type="submit" value="Start Chatting Now" name="submit">
                       </form>
